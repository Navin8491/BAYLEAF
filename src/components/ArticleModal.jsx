          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8 sm:py-10 lg:px-12 lg:py-16 custom-scrollbar relative">
              ...
              >
                ...
                <h1 className="text-4xl lg:text-6xl font-heading font-medium text-[#2F343B] mb-4 leading-[1.1] tracking-tight">
                  {article.title}
                </h1>

                <div className="w-16 h-px bg-[#B89D7C]/50 mb-4"></div>
                ...
                <div className="prose prose-lg prose-p:text-[#667786] prose-p:font-light prose-p:leading-relaxed prose-p:mb-8 prose-headings:font-heading prose-headings:text-[#394652] prose-headings:font-medium prose-strong:text-[#2F343B] prose-strong:font-medium max-w-none">
                  {article.content ? (
                    ...
                    <>
                      <p className="text-xl text-[#394652] font-medium leading-relaxed mb-4">
                      ...
                      <h3 className="text-2xl mt-6 mb-3">The Importance of Origin</h3>
                      <p>
                      ...
                      <blockquote className="border-l-4 border-[#B89D7C] pl-6 py-2 my-6 italic text-[#394652] text-2xl font-light">
