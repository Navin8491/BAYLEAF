...
const About = () => {
  ...
  return (
    <div ref={containerRef} className="bg-[var(--color-soft-ivory)] text-[var(--color-gray-blue)] font-body overflow-x-hidden selection:bg-[var(--color-muted-teal)] selection:text-white">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden px-6 lg:px-12 pt-28 pb-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-12 items-center">
            ...
            <div className="order-2 lg:order-2 lg:pl-12">
              ...
              <h2 className="text-5xl lg:text-7xl font-heading font-medium text-[var(--color-rich-graphite)] mb-6 leading-[1.05]">
                Simplicity <br /> meets <span className="italic font-light text-[var(--color-deep-slate)]">perfection.</span>
              </h2>
              <div className="space-y-4 text-[var(--color-gray-blue)] text-lg font-light leading-relaxed">
                <p>
      ...
      <section className="py-12 lg:py-16 relative z-20 mx-4 lg:mx-8 mb-10 px-6 lg:px-12 reveal-section">
        ...
        <div className="max-w-7xl mx-auto values-container relative z-10">
          <div className="text-center mb-6">
            ...
            <h2 className="text-5xl lg:text-6xl font-heading font-medium text-[var(--color-rich-graphite)] mb-3">What Defines Us</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
            {[
              ...
              <div key={idx} className="value-card bg-[var(--color-soft-ivory)]/80 backdrop-blur-xl border border-[var(--color-silver-fog)]/60 p-6 lg:p-8 rounded-[2rem] md:rounded-[2.5rem] shadow-[0_15px_30px_rgba(56,68,80,0.08)] hover:shadow-[0_25px_50px_rgba(56,68,80,0.15)] transition-all duration-500 hover:-translate-y-2 group">
                ...
                <h3 className="text-2xl font-heading font-medium text-[var(--color-rich-graphite)] mb-3 group-hover:text-[var(--color-muted-teal)] transition-colors duration-300">{value.title}</h3>
      ...
      <section className="py-12 lg:py-16 px-6 lg:px-12 reveal-section relative z-20">
        <div className="max-w-7xl mx-auto gallery-container">
          <div className="flex flex-col md:flex-row justify-between items-end mb-6 gap-4">
            <div>
              <span className="inline-flex items-center gap-2 text-[var(--color-muted-teal)] text-[10px] font-bold uppercase tracking-[0.2em] mb-2">
      ...
      <section className="py-24 lg:py-28 px-6 lg:px-12 text-center reveal-section relative overflow-hidden bg-[var(--color-silver-fog)]/30 backdrop-blur-xl border-t border-[var(--color-silver-fog)]/50 mt-6">
        <div className="max-w-4xl mx-auto relative z-10">
          <span className="text-[10px] tracking-[0.4em] uppercase font-bold text-[var(--color-muted-teal)] mb-3 block">Join Us</span>
          <h2 className="text-5xl md:text-7xl lg:text-[6.5rem] font-heading font-medium text-[var(--color-rich-graphite)] mb-4 leading-[1.05] tracking-tight">Experience the <br/><span className="italic font-light text-[var(--color-deep-slate)]">difference.</span></h2>
          <p className="text-lg text-[var(--color-gray-blue)] mb-8 font-light max-w-xl mx-auto leading-relaxed">
