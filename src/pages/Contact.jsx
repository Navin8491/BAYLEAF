...
const Contact = () => {
  ...
  return (
    <div ref={containerRef} className="bg-[var(--color-soft-ivory)] min-h-screen text-[var(--color-gray-blue)] overflow-x-hidden font-body selection:bg-[var(--color-muted-teal)] selection:text-white">
      ...
      <section className="relative pt-48 pb-20 px-6 lg:px-12 flex flex-col items-center">
        <div className="max-w-4xl mx-auto text-center z-10 relative">
          ...
          <h1 className="text-6xl md:text-8xl lg:text-[8rem] font-heading font-medium text-[var(--color-rich-graphite)] leading-[0.9] mb-10 tracking-tight overflow-hidden">
            <span className="block contact-hero-text">Say <span className="italic font-light text-[var(--color-deep-slate)]">Hello.</span></span>
          </h1>
          
          <div className="w-24 h-[1px] bg-[var(--color-silver-fog)] mx-auto mb-10 contact-hero-text"></div>
      ...
      <section className="contact-section py-24 px-6 lg:px-12 relative z-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={idx} className="contact-card flex items-start gap-8 p-10 bg-[var(--color-soft-ivory)]/60 backdrop-blur-xl rounded-[2.5rem] border border-[var(--color-silver-fog)]/50 hover:bg-white hover:shadow-[0_20px_40px_rgba(56,68,80,0.08)] transition-all duration-500 group">
                  <div className="text-[var(--color-silver-fog)] group-hover:text-[var(--color-muted-teal)] transition-colors duration-500 mt-1">
                    {item.icon}
                  </div>
                  <div>
                    <h3 className="text-xl font-heading font-medium text-[var(--color-rich-graphite)] mb-3">{item.title}</h3>
            ...
            {/* Aesthetic Image */}
            <div className="contact-img-container aspect-[4/5] rounded-[3rem] overflow-hidden relative shadow-[0_30px_60px_rgba(47,52,59,0.15)] mt-8 hidden lg:block border border-[var(--color-silver-fog)] bg-white p-3">
          ...
          <div className="lg:col-span-7 contact-form-container relative">
            ...
            <div className="bg-[var(--color-soft-ivory)]/80 backdrop-blur-2xl p-10 lg:p-16 rounded-[3rem] shadow-[0_30px_60px_rgba(56,68,80,0.1)] border border-[var(--color-silver-fog)]/60 relative overflow-hidden">
              <h2 className="text-4xl lg:text-5xl font-heading font-medium text-[var(--color-rich-graphite)] mb-12 form-element">Drop us a line</h2>
              
              <form className="flex flex-col gap-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="flex flex-col gap-3 form-element group">
                    ...
                    <input 
                      type="text" 
                      placeholder="Jane"
                      className="w-full bg-transparent border-b border-[var(--color-silver-fog)] py-4 text-[var(--color-rich-graphite)] placeholder-[var(--color-silver-fog)] focus:outline-none focus:border-[var(--color-muted-teal)] transition-colors rounded-none"
                    />
                  </div>
                  <div className="flex flex-col gap-3 form-element group">
                ...
                <div className="flex flex-col gap-3 form-element group">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-transparent border-b border-[var(--color-silver-fog)] py-4 text-[var(--color-rich-graphite)] placeholder-[var(--color-silver-fog)] focus:outline-none focus:border-[var(--color-muted-teal)] transition-colors rounded-none resize-none"
                  ></textarea>
                </div>

                <button 
                  type="button"
                  className="form-element self-start mt-8 flex items-center justify-center gap-4 bg-gradient-to-br from-[var(--color-muted-teal)] to-[var(--color-deep-sage-teal)] text-white px-12 py-5 rounded-full text-[11px] font-bold tracking-[0.2em] uppercase hover:from-[var(--color-deep-sage-teal)] hover:to-[var(--color-muted-teal)] transition-all duration-500 shadow-[0_15px_30px_rgba(95,124,123,0.3)] hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(95,124,123,0.4),0_0_20px_rgba(194,163,131,0.4)] group overflow-hidden relative"
                >
